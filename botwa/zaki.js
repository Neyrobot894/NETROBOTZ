...
break
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            case 'antilink': {
             ...
             break
            case 'linkgroup': case 'linkgc': case 'linkgc': {
                if (!m.isGroup) throw mess.group
...
➣ Url : ${anu.url}`,
	    ...
	    case 'ytmp3': case 'ytaudio': {
            ...
            break
            case 'ytmp4': case 'ytvid': case 'ytvideo': {
        ...
        if (stderr.trim()) m.reply(stderr)
            ...
            break
                    case 'bug': case 'report': {
                    	...
                    	zaki.sendMessage(`6282136821559@s.whatsapp.net`, {text: `*Bug Report From:* wa.me/${m.sender.split("@")[0]}
Report Message: ${text}` })
...
case 'cry':case 'kill':case 'hug':case 'pat':case 'lick':case 'kiss':case 'bite':case 'yeet':case 'neko':case 'bully':case 'bonk':case 'wink':case 'poke':case 'nom':case 'slap':case 'smile':case 'wave':case 'awoo':case 'blush':case 'smug':case 'glomp':case 'happy':case 'dance':case 'cringe':case 'cuddle':case 'highfive':case 'shinobu':case 'megumin':case 'handhold':
				...
				case 'waifu': case 'loli':
					...
					break
case '?': case 'menu': case 'help': case 'bot': case 'netrobot': case 'netro': case 'halo': case 'hi':
...
anu = ` _*Hai Kak ${pushname} ${ucapanWaktu} 👋.*_
...
//━━━━━━━━━━━━━━━[ MENU LOC ]━━━━━━━━━━━━━━━\\
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({ templateMessage: { hydratedTemplate: { hydratedContentText: anu.trim(), locationMessage: { jpegThumbnail: fs.readFileSync('./media/menu.jpg') }, hydratedFooterText: `Jangan Spam Bot Jika Tidak Ingin Di Banned!`, hydratedButtons: [{ urlButton: { displayText: 'YouTube', url: 'https://youtube.com/channel/UCbPD6WnYyXsS5EWNlc-XRVw'} }, { urlButton: { displayText: 'Group', url: 'https://chat.whatsapp.com/ItrIikp5DOyLuX3qI7Ae05'} }, { quickReplyButton: { displayText: 'Owner', id: 'owner', } }, { quickReplyButton: { displayText: 'Donasi', id: 'donate', } }] } } }), { userJid: m.sender, quoted: m }); //conn.reply(m.chat, text.trim(), m) 
  zaki.relayMessage( m.chat, template.message, { messageId: template.key.id } )
...
case 'owner': case 'creator': {
    ...
    + 'item1.X-ABLabel:Creator 𝙽𝙴𝚃𝚁𝙾𝙱𝙾𝚃𝚉\n' //Info Kalian
    + 'item2.EMAIL;type=INTERNET:netrobotcenter@gmail.com\n' // Email Kalian
    + 'item2.X-ABLabel:Email\n'
    + 'item3.URL:https://instagram.com/netrobotz\n' //Ig Kalian Atau Web Kalian
    + 'item3.X-ABLabel:Instagram\n'
    + 'item4.ADR:;;Indonesia;;;;\n' //Negara Kalian
    + 'item4.X-ABLabel:Region\n'
    + 'END:VCARD'
zaki.sendMessage(m.chat, { contacts: { displayName: '𝙻𝙸𝙾𝙽𝙶𝙰𝙼𝙸𝙽𝙶𝚈𝚃', contacts: [{ vcard }] } }, { quoted: m })
            }
break 
...
break
	    case 'donasi': case 'donate': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                zaki.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/923ab4d948cebcb94a498.jpg' }, caption: `*── 「 DONASI 」 ──*\n\n_Kalian Bisa Dukung Bot Dengan Donasi Ke :_\n _》Dana : 082138356143_\n _》Gopay : 082136821559_\n _》Pulsa : 082138356143 ( Telkomsel )_\n\n_Donasi Kalian Sangat Berarti._\n\n_Contact person Owner:_\n_wa.me/6282136821559_` }, { quoted: m })
            }
            break
            default:
                if (budy.startsWith('=>')) {
